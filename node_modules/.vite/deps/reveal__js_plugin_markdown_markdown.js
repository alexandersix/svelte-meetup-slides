...
var require_markdown = __commonJS({
  "node_modules/reveal.js/plugin/markdown/markdown.js"(exports, module) {
    !function(e, t) {
      ...
      const D = "__SCRIPT_END__", M = /\[\s*((\d*):)?\s*([\s\d,|-]*)\]/, P = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
      return () => {
        let e2;
        function t2(e3) {
        ...
        return { id: "markdown", init: function(t3) {
          ...
          return n3 || (n3 = new N.Renderer(), n3.code = (e3, t4) => {
            ...
            if (M.test(t4)) {
              let e4 = t4.match(M)[2];
              e4 && (n4 = `data-ln-start-from="${e4.trim()}"`), r4 = t4.match(M)[3].trim(), r4 = `data-line-numbers="${r4}"`, t4 = t4.replace(M, "").trim();
            }
            return `<pre><code ${r4} ${n4} class="${t4}">${e3 = e3.replace(/([&<>'"])/g, (e4) => P[e4])}</code></pre>`;
